...
// function will print developer's name and currrent date and time
void printSystemProperties()
{
	time_t timetoday;
	time(&timetoday);
	std::cout << "Developer: Binyamin Babaev. Current date and time: " << asctime(localtime(&timetoday)) << std::endl;
}
